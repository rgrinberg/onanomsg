...
(* OASIS_START *)
(* DO NOT EDIT (digest: 343e2684b31439f9db4a3e039708fed8) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_nanomsg", []))];
                      ...
                      Some
                        (("cc",
                           [
                              "-shared";
                              "-o";
                              "_build/lib/dllnanomsg_stubs.so";
                              "-lnanomsg"
                           ])))
                 ];
               post_command = [(OASISExpr.EBool true, None)];
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_cclib = [(OASISExpr.EBool true, ["-lnanomsg"])];
                      bs_dlllib =
                        [(OASISExpr.EBool true, ["-lnanomsg_stubs"])];
                      bs_dllpath = [(OASISExpr.EBool true, [])];
                      bs_byteopt = [(OASISExpr.EBool true, [])];
                      bs_nativeopt = [(OASISExpr.EBool true, [])];
                      },
                   {
                      lib_modules = ["Nanomsg"; "Onanomsg"];
                      lib_pack = false;
               ...
               Executable
                 ({
                     ...
                     },
                   {
                      ...
                      bs_path = "lib_test";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "nanomsg"];
                      bs_build_tools =
                   ...
                   {exec_custom = true; exec_main_is = "test_reqrep.ml"; });
               Executable
                 ({
                     cs_name = "test_endpoint";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {exec_custom = true; exec_main_is = "test_endpoint.ml"; });
               Executable
                 ({
                     cs_name = "test_pubsub";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = true; exec_main_is = "test_pubsub.ml"; });
               Executable
                 ({
                     cs_name = "test_opts";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = true; exec_main_is = "test_opts.ml"; });
               Executable
                 ({
                     cs_name = "pipeline";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = true; exec_main_is = "pipeline.ml"; });
               Executable
                 ({
                     cs_name = "reqrep";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = true; exec_main_is = "reqrep.ml"; });
               Executable
                 ({
                     cs_name = "pair";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = true; exec_main_is = "pair.ml"; });
               Test
                 ({
                     cs_name = "test_nanomsg";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\150X\0245\020\152/\221\128\243\238\133\153b\022Z";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
