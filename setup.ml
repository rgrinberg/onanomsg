...
(* OASIS_START *)
(* DO NOT EDIT (digest: 0dbd95e291353c36050e7e472949e539) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = true; exec_main_is = "run_tests.ml"; });
               Executable
                 ({
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "4\164\144/\253\221\005\246ym)\195\134\b\020\173";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
